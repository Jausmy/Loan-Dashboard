...
- Comparative Analysis: We compared the financial profiles and risk scores of approved and declined applicants to identify key factors that influence loan approval decisions. This involved grouping data by approval status and calculating descriptive statistics for key metrics such as credit scores, annual income, and debt-to-income ratios.
- Correlation Analysis: We calculated the correlation between various financial factors and risk scores to identify potential relationships between applicant characteristics and the likelihood of loan default. This involved using statistical methods to measure the strength and direction of the linear relationship between these variables.
- Diagnostic Analysis: This analysis was used to identify the root cause of any significant fluctuations in loan approval rates or risk scores over time. By examining various factors such as economic conditions, changes in lending policies, or shifts in applicant demographics, we aimed to understand the underlying reasons for these fluctuations2.
...
- Moderate positive correlation: A moderate positive correlation was observed between risk score and credit card utilization rate, suggesting that higher credit card utilization is associated with increased risk.
